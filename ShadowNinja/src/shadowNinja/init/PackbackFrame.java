 ...
 * @see LoginFrame
 */
public class PackbackFrame extends JFrame {
	
	//登录的用户信息
	public static User user;
	
	//背包中武器数量
	public static int numWeapon;
	 ...
	 */
	public PackbackFrame() throws UnsupportedAudioFileException, IOException, LineUnavailableException {
		...
		CaiDan.addMouseListener(new MouseListener(){
			...
			*/public void mouseClicked(MouseEvent e) {					 
				try {
					...
					numWeapon = user.getWeaponNumber(user);
					System.out.println(numWeapon + "?");
					numPerson = user.getPersonNumber(user);
