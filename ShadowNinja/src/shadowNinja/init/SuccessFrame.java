...
public class SuccessFrame extends JFrame {
	 ...
	 */
	public SuccessFrame(String str) throws UnsupportedAudioFileException, IOException, LineUnavailableException {
		confirm = new JLabel("");// 创建对象
		confirm.setBounds(1000, 565, 80, 70);// 确定位置
...
//	
	...
	class MainPanel extends JPanel {// 创建的MainPanel类，在MainFrame中调用
		...
		public MainPanel() {
			try {
				background = ImageIO.read(new File("src/shadowNinja/init/res/Success.png"));
			} catch (IOException e) {
				e.printStackTrace();
			}
		}
